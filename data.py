...
parser.add_argument("--frame_size", type=int, default=80)
...
def program(sample_rate: int, duration: float, frame_size: int, hop_length: int, length_seq: int, tokenizer_path: str, csv_path: str, audio_folder: str, clean_path: str):
    ...
    text_data = text_processor.process(sequences=contents, max_len=length_seq, start_token=True, end_token=True)
